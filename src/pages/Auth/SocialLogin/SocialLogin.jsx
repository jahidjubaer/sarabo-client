...
// sync fails, the inline FormAlert surfaces and the `location.state` navigation are all
...
const SocialLogin = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            setFormAlert({ tone: 'danger', title: 'Google sign-in failed', text: getAuthErrorMessage(error) });
            setSubmitting(false);
            return;
        }
    ...
    return (
        <div className="mt-6">
            ...
            <FormAlert alert={formAlert} className="mt-4" />
        </div>
    );
};
